	...
	<div class="tablesc">
		...
		<div class="table-content">	
			<div class="table-row">		
				...
				<div class="table-data"><a style={{cursor:'pointer'}} onClick={()=>navigatePage('https://www.youtube.com/embed/07QZLM9aCaA?si=NtpIA2LQzq1_X-O-',' MSFI AI Chatbot',"sample") } target='_blank'>Click here for Video</a></div>
				<div class="table-data"><a >-</a></div>
        <div class="table-data"><a href={ppt1} download="MSFI AI Chatbot" target='_blank' rel="noreferrer" >Click here to view PPT</a></div>
				<div class="table-data"><a >-</a></div>
		</div>
        
			<div class="table-row">
				<div class="table-data">Open AI</div>
				<div class="table-data"><a style={{cursor:'pointer'}} onClick={()=>navigatePage('https://www.youtube.com/embed/kXDKgPaQp_E?si=a3UaiH0_OobA0pJ_','Open AI','sample')}target = "_blank">Click here for Video</a></div>
				<div class="table-data"><a >-</a></div>
				<div class="table-data"><a href={ppt2} download="Open AI" target='_blank' rel="noreferrer" > Click here to view PPT</a></div>
				<div class="table-data"><a >-</a></div>
			</div>
